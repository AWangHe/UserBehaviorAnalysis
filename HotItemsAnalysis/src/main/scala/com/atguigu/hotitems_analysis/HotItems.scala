...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    //2.读取数据
   // val dataStream: DataStream[UserBehavior] = env.readTextFile("E:\\JAVA\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
